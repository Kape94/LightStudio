...
namespace FlatShadingShaderCodes {
...
void FlatShadingEffect::Create()
{
  shader.Create(FlatShadingShaderCodes::vertex, FlatShadingShaderCodes::fragment);
}

//---------------------------------------------------------------------------------------

void FlatShadingEffect::Cleanup()
{
  shader.Delete();
}
...
std::string FlatShadingEffect::Name() const
{
  return "Flat shading model";
}
